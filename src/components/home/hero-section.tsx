...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 bottom-0 w-1 z-[2]">
        <div className="h-full bg-gradient-to-b from-transparent via-gold to-transparent opacity-50" />
      </div>
      ...
      <div className="relative z-10 w-full container-luxury section-padding pt-32 pb-36">
        <div className="max-w-3xl">
          ...
          >
            Propiedades exclusivas en los corredores más cotizados de México.
            Experiencia, discreción y resultados de alto valor percibido.
          </motion.p>
